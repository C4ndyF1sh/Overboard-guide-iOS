...
2. Execute "while true; do jetsamctl -l 5490 -M 5490 App Name; sleep 1; done" in NewTerm3 Beta, for iOS 15 devices use "jetsamctl -l 5490 MeloNX" if the other command fails.
